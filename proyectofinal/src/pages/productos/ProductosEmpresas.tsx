    ...
    <>
      <div className="relative">
        <div className="w-[90%] mx-auto">
          {productos.length > 0 && (
            <FondoColor
              fondo={productos[0].empresa.fondo}
              texto={productos[0].empresa.texto}
              nombre={productos[0].empresa.nombre}
              imagen={productos[0].empresa.logo}
            />
          )}
          <Carrito />
...
export default ProdcutosEmpresas;
